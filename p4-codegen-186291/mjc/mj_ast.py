...
class Assignment(Expr):
    """Node representing an Assigment Expression"""
...
class MethodCall(Expr):
    ...
    def __init__(
        ...
        #print("PRINT: ", args)
        #print("PRINT: ", args.exprs)
        #print("PRINT: ",args.exprs[0])
    ...
    def children(self):
        ...
        if self.args is not None:
            ...
            #for i, expr in enumerate(self.args.exprs):
            #    nodelist.append((f"arg[{i}]", expr))
        return tuple(nodelist)
...
class Assert(Statement):
    """Node representing an Assert statment"""
...
class Print(Statement):
    """Node represeting the Print statement"""
...
class MethodDecl(Node):
    ...
    def children(self):
        ...
        # Adiciona tipo e nome se forem nós
        ...
        if isinstance(self.param_list, list):
            for i, param in enumerate(self.param_list):
                nodelist.append((f"param_list[{i}]", param))
        elif self.param_list:
            nodelist.append(("param_list", self.param_list))

        # Adiciona o corpo do método
        if self.body:
            nodelist.append(("body", self.body))
...
class MainMethodDecl(Node):
    """Node represeting the Main Method Declaration"""
...
class ClassDecl(Node):
    ...
    def __init__(
        ...
        #print(f"DEBUG ClassDecl: name={name}, method_decls={method_decls}")
        """
